...
import com.example.diploma.util.duckham.DoubleComparator;
import com.example.diploma.util.duckham.model.Edge;
import com.example.diploma.util.duckham.model.Triangle;
import com.example.diploma.util.duckham.model.Vertex;
...
public class DuckhamHull {
	...
	public DuckhamHull(Geometry geometry, double threshold) {
		this.geometries = transformIntoPointGeometryCollection(geometry);
		this.threshold = threshold;
		this.geomFactory = geometry.getFactory();
	}
	public DuckhamHull(GeometryCollection geometries, double threshold) {
	...
	private Geometry concaveHull() {
		...
		Collection<ConstraintVertex> qeVertices =
			qes.getVertices(false);
		
		int iV = 0;
		for (ConstraintVertex v : qeVertices) {
